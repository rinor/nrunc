...
import (
	...
	"github.com/rinor/nrunc/internal/constants"
	m "github.com/rinor/nrunc/internal/metrics"
	"github.com/rinor/nrunc/pkg/network"
...
func (u *Unikontainer) Kill() error {
	...
	err = network.Cleanup("tap0_nrunc")
	if err != nil {
		Log.Errorf("failed to delete tap0_nrunc: %v", err)
	}
	return nil
}
